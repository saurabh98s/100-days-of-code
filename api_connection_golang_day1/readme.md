so day1 went on great, i had created a web api using golang, today i used JS to create a basic web page to display those elements retrieving from the api.
